...
const clientId = "3ed31b02afc92961b4cf43d368af395d"; // get from https://dashboard.web3auth.io
...
function App() {
      ...
      try {
        const web3auth = new Web3Auth({
          ...
          chainConfig: {
            ...
            chainId: "0x61",
            rpcTarget: "https://data-seed-prebsc-1-s2.bnbchain.org:8545",
          },
        });
  ...
  return (
    ...
    >
      ...
      Task 2: Ethereum Smart Wallet Development
      </h3>
